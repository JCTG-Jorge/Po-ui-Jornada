...
*******************************************************************************/
{include/i-prgvrs.i ESCD0402 12.01.15.000}
...
DEFINE VARIABLE c-class-fim AS CHARACTER FORMAT "9999.99.99":U INITIAL "99999999" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-class-ini AS CHARACTER FORMAT "9999.99.99":U 
     LABEL "Class Fiscal" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-imp
     ...
     rs-execucao AT ROW 5.75 COL 2.86 HELP
...
DEFINE FRAME f-pg-sel
     c-class-ini AT ROW 3.92 COL 15 COLON-ALIGNED
     c-class-fim AT ROW 3.92 COL 48.14 COLON-ALIGNED NO-LABEL
     fi-item-ini AT ROW 5.25 COL 15 COLON-ALIGNED WIDGET-ID 22
     fi-item-fim AT ROW 5.25 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 20
     IMAGE-1 AT ROW 3.96 COL 32.43
     IMAGE-2 AT ROW 3.96 COL 46.86
     IMAGE-19 AT ROW 5.29 COL 32.43 WIDGET-ID 24
     IMAGE-20 AT ROW 5.29 COL 46.86 WIDGET-ID 26
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "ESCD0402" "12.15.01.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-class-ini c-class-fim fi-item-ini fi-item-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-19 IMAGE-20 c-class-ini c-class-fim fi-item-ini 
         fi-item-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.it-codigo-ini   = INPUT FRAME f-pg-sel fi-item-ini
           tt-param.it-codigo-fim   = INPUT FRAME f-pg-sel fi-item-fim
           tt-param.c-class-ini     = INPUT FRAME f-pg-sel c-class-ini 
           tt-param.c-class-fim     = INPUT FRAME f-pg-sel c-class-fim .
  ...
  //  {include/i-rpexb.i}
    ...
    {include/i-rprun.i esp/escd0402rp.p}
